  ...
  return (
    <section className="about-section" id="about">
      <div className="container">
        ...
        <p data-aos="fade-up">
         Halo, saya Lutfi Andika seorang pelajar dari SMK TELEKOKOMUNIKASI TELESANDI BEKASI yang fokus mendalami dunia 
         front-end development dan desain digital. Saya tertarik membangun tampilan web yang modern,
         responsive, dan nyaman digunakan, serta terus mengembangkan skill di HTML, CSS, JavaScript,
         React, Tailwind, UI/UX, hingga Git & GitHub. Selain itu, saya juga membuat poster digital dan
         beberapa project web sebagai bagian dari proses belajar saya. Portfolio ini saya buat sebagai
         tempat untuk menunjukkan perjalanan, kemampuan, serta karya yang sudah saya bangun sejauh ini.
        </p>

        <ul className="skills-list" data-aos="fade-up">
          <li>HTML • CSS • JavaScript</li>
          <li>Bootstrap • Tailwind • Flowbite • UI Verse • Gekshelp</li>
...
.skills-list li{margin:4px 0;color:#cdd6f4;font-size:15px;}`,
...

          {
            ...
            name: "home.css",
            content: `/* home.css */
.home-terminal{display:flex;align-items:center;justify-content:center;padding:70px 20px}
...
export default defineConfig({ plugins: [react()] });`,
  ...
  // backend, devops, tools, package.json, README tetap sama — tidak perlu diubah
];
